    ...
    <div className="flex flex-col justify-center items-center ">
      ...
      <div className="flex flex-col justify-center items-center bg-[#272727] p-2 w-[90vw] md:w-fit md:p-11 mx-3 rounded-lg">
        <div className=" m-1 flex flex-col w-full" >
          <p className="text-white text-center text-xl md:text-2xl mb-3 font-bold " >Hey! Welcome to <span  className="text-red-500 inline" > VideoTube</span></p>
        ...
        <input
          ...
          />
           ...
           <div className=" m-1 flex flex-col w-full" >
          <label className="text-white mt-5" htmlFor="username" >Password :</label>
        <input
          type="password"
